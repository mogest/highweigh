...
Look, you're a technical person, you're not afraid of a bit of YAML from time to time, and for the love all things
...
Check out the sample `data.yaml`, and replace it with your projects and timelines.  Publish the contents of this
repository to whatever static web server you have handy.  Get back to doing other stuff.

If you're not a YAML fan, try out `data.json` instead.

If you're feeling really fancy, make a script to generate the YAML or JSON from whatever source you're using to store this
